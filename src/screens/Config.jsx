		...
		if (this.state.color_background === undefined) {
			return (
				<View
					style={[
						styles.container,
						{ backgroundColor: this.state.color_background },
					]}>
			...
			return (
				<View
					...
					<Text style={{ paddingBottom: 50 }}>
						Browse your color on google in hex code
					</Text>
					...
					<View style={styles.box2}>
						...
						<TextInput
							style={[styles.io, { backgroundColor: this.state.color_panel }]}
							returnKeyType='next'
							enablesReturnKeyAutomatically
							blurOnSubmit={false}
					...
					<View style={styles.box2}>
						...
						<TextInput
							style={[
								styles.io,
								{ backgroundColor: this.state.color_button_encrypt },
							]}
							returnKeyType='next'
							enablesReturnKeyAutomatically
							blurOnSubmit={false}
					...
					<View style={styles.box2}>
						...
						<TextInput
							style={[
								styles.io,
								{ backgroundColor: this.state.color_button_decrypt },
							]}
							returnKeyType='next'
							enablesReturnKeyAutomatically
							blurOnSubmit={false}
